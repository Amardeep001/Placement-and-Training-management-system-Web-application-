...
<html lang="en">
    ...
    <head>
        ...
        <title>IIIT Naya Raipur Placement Cell</title>
        <!-- Bootstrap Core CSS -->
    ...
    <body id="page-top">
	<div>
        <h1><a class="navbar-brand page-scroll" href="https://www.iiitnr.ac.in/">International Institute of Information Technology</a> </h1>
</div>
			<nav id="mainNav" class="navbar navbar-default navbar-fixed-top" style="background:black">
                ...
                <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                    <ul class="nav navbar-nav navbar-right">
                        <li>
                            <a class="page-scroll" href="login.php">Student Login</a>
                        </li>
                        <li>
                            <a class="page-scroll" href="#">HOD Login</a>
                        </li>
                        <li>
                            <a class="page-scroll" href="#">Placement Login</a>
                        </li>
                        <li>
                            <a class="page-scroll" href="#">Administrative Login</a>
                        </li>
                    </ul>
